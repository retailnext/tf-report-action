...
import { buildResourceChanges } from "./resources.js";
import { buildSummary } from "./summary.js";
import { buildOutputChanges } from "./outputs.js";

/**
 * Builds a Report from a parsed Plan.
 * Orchestrates: buildConfigRefs → buildResourceChanges → buildSummary → buildOutputChanges → group by module.
 */
export function buildReport(plan: Plan, options: BuildOptions = {}): Report {
  ...
  // Sort modules: root first, then alphabetical
