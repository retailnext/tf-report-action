/**
 * Apply-specific context helpers for rendering apply reports.
 *
 * Provides per-resource failure status and diagnostics lookup used by
 * element classes when rendering apply reports with inline error details.
 */
